...
export const metadata: Metadata = {
  title: "Terms of Service — TeamTaskPro",
  description: "The terms that govern your use of TeamTaskPro.",
};

export default function TermsPage() {
  return (
    <LegalDoc title="Terms of Service" updated="June 2026">
      <p>These Terms of Service (&ldquo;Terms&rdquo;) govern your access to and use of TeamTaskPro (&ldquo;the Service&rdquo;). By creating an account or using the Service, you agree to these Terms. If you do not agree, please do not use the Service.</p>

      <h2>Using the Service</h2>
      <p>You must be at least 16 years old and able to form a binding agreement to use TeamTaskPro. You are responsible for the activity that happens under your account and for keeping your login credentials secure.</p>
      ...
      <h2>Your content</h2>
      <p>You retain ownership of the tasks, text, and other content you add to TeamTaskPro. You grant us the limited permission needed to store and display that content for the purpose of operating the Service for you and your workspace.</p>
      ...
      <p>To the maximum extent permitted by law, TeamTaskPro will not be liable for any indirect, incidental, or consequential damages, or for any loss of data or profits, arising from your use of the Service.</p>
      ...
      <h2>Contact</h2>
      <p>If you have questions about these Terms, contact us at <a href="mailto:hello@teamtaskpro.com">hello@teamtaskpro.com</a>.</p>
    </LegalDoc>
  );
}
