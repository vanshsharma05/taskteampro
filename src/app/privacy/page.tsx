...
export const metadata: Metadata = {
  title: "Privacy Policy — TaskTeamPro",
  description: "How TaskTeamPro collects, uses, and protects your information.",
};

export default function PrivacyPage() {
  return (
    <LegalDoc title="Privacy Policy" updated="July 2026">
      <p>This Privacy Policy explains how TaskTeamPro (&ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;the Service&rdquo;) collects, uses, and protects information when you use our website and application. By using TaskTeamPro, you agree to the practices described here.</p>
      ...
      <p>TaskTeamPro offers an optional integration with Google Calendar. If you sign in with Google or connect your Google Calendar, we request permission to view your calendars and events (<code>calendar.readonly</code>) and to create and manage events (<code>calendar.events</code>). We use this access solely to:</p>
      <ul>
      ...
      <p>TaskTeamPro&rsquo;s use and transfer of information received from Google APIs adheres to the <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer">Google API Services User Data Policy</a>, including the Limited Use requirements.</p>
      <p>You can revoke TaskTeamPro&rsquo;s access to your Google account at any time from your <a href="https://myaccount.google.com/permissions" target="_blank" rel="noopener noreferrer">Google Account permissions page</a>.</p>

      <h2>Sharing</h2>
      <p>We share information only with the service providers that help us operate TaskTeamPro, such as our hosting and database provider, and where required by law. Within a company workspace, the content you create may be visible to other members and administrators of that workspace.</p>
      ...
      <h2>Children</h2>
      <p>TaskTeamPro is intended for use by businesses and is not directed to children under the age of 16. We do not knowingly collect personal information from children.</p>
      ...
      <h2>Contact</h2>
      <p>If you have questions about this Privacy Policy, contact us at <a href="mailto:hello@taskteampro.com">hello@taskteampro.com</a>.</p>
    </LegalDoc>
  );
}
